...
# Add some function which is written by stevekcolin
    ...
    def get_checkable(self,locator):
        ...
        `introduction` for details about locating elements.
        """
        self._info("Get Checkable '%s'." % locator)
        element = self._element_find(locator, True, True)
        return element.get_attribute("checkable")
    ...
    def get_enabled(self,locator):
        ...
        `introduction` for details about locating elements.
        """
        self._info("Get enabled '%s'." % locator)
        element = self._element_find(locator, True, True)
        return element.get_attribute("enabled")

    def get_focusable(self,locator):
        """get value of element identified by `locator`.
        get value of the element
        Key attributes for arbitrary elements are `index` and `name`. See
        `introduction` for details about locating elements.
        """
        self._info("Get focusable '%s'." % locator)
        element = self._element_find(locator, True, True)
        return element.get_attribute("focusable")

    def get_focused(self,locator):
        """get value of element identified by `locator`.
        get value of the element
        Key attributes for arbitrary elements are `index` and `name`. See
        `introduction` for details about locating elements.
    ...
    def get_scrollable(self,locator):
        ...
        `introduction` for details about locating elements.
        """
        self._info("Get scrollable '%s'." % locator)
        element = self._element_find(locator, True, True)
        return element.get_attribute("scrollable")
    ...
    def get_selected(self,locator):
        ...
        `introduction` for details about locating elements.
        """
        self._info("Get selected '%s'." % locator)
        element = self._element_find(locator, True, True)
